...
def get_expected_sha256():
    ...
    file_url = 'https://download.videolan.org/pub/videolan/vlc/last/win64/vlc-3.0.23-win64.exe.sha256'
    resp_msg = requests.get(file_url)

    print('Downloading expected SHS-256 of VLC installer....', end="")

    if resp_msg.status_code == requests.codes.ok:
        print('success')
    else: 
        print('failure')
        print(f'Response code: {resp_msg.states_code} {resp_msg.reason}')
        exit()
    
    #create text of hash
    file_content = resp_msg.text.split()
    print(f'Expected SHA-256 of VLC installer: {file_content[0]}')
...
def download_installer():
    ...
    file_url = 'https://download.videolan.org/pub/videolan/vlc/last/win64/vlc-3.0.23-win64.exe'
    resp_msg = requests.get(file_url)

    print('Downloading SHA-256 of VLC installer....', end="")
...
def installer_ok(installer_data, expected_sha256):
    ...
    print('Checking expected and installer hash...', end='')
...
def run_installer(installer_path):
    ...
    print('Running installer at', installer_path)
