...
def main():
    ...
    #records, captures = filter_log_by_regex(log_path, r'invalid user.*220.195.35.40', print_summary= True, print_records=True)
    #records, captures = filter_log_by_regex(log_path, r'error', print_summary= True, print_records=True)
    ...
    df.to_csv('captures.csv', index=False, header=('Sourse IP', 'Destination IP', 'Length'))
